...
public class FixedItemInvTester extends ItemInvTester {
    ...
    public void testBasics() {
        ...
        for (int i = 0; i < 10; i++) {
            assertItem(ITEMS[i], inv1.getStack(i));
            assertItem(ITEMS[i + 10], inv2.getStack(i));
            assertItem(ITEMS[i + 20], inv3.getStack(i));
        }
    }
    ...
    public void testSubInventories() {
        ...
        assertItem(ITEMS[3], sub1.getStack(0));
        assertItem(ITEMS[4], sub1.getStack(1));
        ...
        assertItem(ITEMS[4], sub2.getStack(0));
    ...
    public void testMappedInventories() {
        ...
        assertItem(ITEMS[4], map1.getStack(0));
        assertItem(ITEMS[7], map1.getStack(1));
        assertItem(ITEMS[3], map1.getStack(2));
        assertItem(ITEMS[8], map1.getStack(3));
        assertItem(ITEMS[2], map1.getStack(4));
        assertItem(ITEMS[9], map1.getStack(5));
        assertItem(ITEMS[0], map1.getStack(6));
        assertItem(ITEMS[5], map1.getStack(7));
        assertItem(ITEMS[6], map1.getStack(8));
        assertItem(ITEMS[1], map1.getStack(9));
        ...
        assertItem(ITEMS[15], map2.getStack(0));
        assertItem(ITEMS[11], map2.getStack(1));
        assertItem(ITEMS[17], map2.getStack(2));
        assertItem(ITEMS[18], map2.getStack(3));
    ...
    public void testCombinedInventories() {
        ...
        for (int i = 0; i < 30; i++) {
            assertItem(ITEMS[i], combined123.getStack(i));
        }
